...
export const INITIAL_SERIES: Series[] = [
  ...
  },
  {
    ...
    descricao: "Princípios bíblicos e práticos para uma vida financeira saudável.",
    destaque: false,
    ordem: 1,
    ano: 2025
  },
  {
    id: "orfaos-a-filho-2025",
    titulo: "De Órfãos a Filho - 2025",
    descricao: "Série original sobre paternidade e cura.",
    destaque: false,
    ordem: 2,
    ano: 2025
  }
...
export const INITIAL_EPISODES: Episode[] = [
  ...
  { id: "sementes-2", serieId: "sementes-2025", ordem: 4, titulo: "SEMENTES QUE GERAM LIBERTAÇÃO FINANCEIRA | SEMANA 4", youtubeVideoId: "PFcNbZs0lCU", duracao: "1h 00min 28s", descricaoCurta: "Mentalidade, fé e responsabilidade." },
  { id: "sementes-3", serieId: "sementes-2025", ordem: 3, titulo: "SEMENTES QUE GERAM LIBERTAÇÃO FINANCEIRA | SEMANA 3", youtubeVideoId: "SRZ87Km_-1c", duracao: "1h 10min 55s", descricaoCurta: "Passos práticos para sair de ciclos e construir constância." },
  { id: "sementes-4", serieId: "sementes-2025", ordem: 2, titulo: "SEMENTES QUE GERAM LIBERTAÇÃO FINANCEIRA | SEMANA 2", youtubeVideoId: "ejzKhJfPK4E", duracao: "49min 18s", descricaoCurta: "Fundamentos para organizar e semear com sabedoria." },
  { id: "sementes-5", serieId: "sementes-2025", ordem: 1, titulo: "SEMENTES QUE GERAM LIBERTAÇÃO FINANCEIRA | SEMANA 1", youtubeVideoId: "Qs3QhSUCPjw", duracao: "54min 02s", descricaoCurta: "Introdução: visão, propósito e primeiros passos." }
];
